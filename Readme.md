# PurgeCSS: Pug extractor for Pug with frontmatter [![badge](https://badgen.now.sh/npm/v/purgecss-from-pug-with-frontmatter)](https://www.npmjs.com/package/purgecss-from-pug-with-frontmatter)
